...
WORDLIST_FILENAME = "/Users/umer/Desktop/MIT 6.00.1x/psets/pset_4/words.txt"
...
def updateHand(hand, word):
    ...
    hand_copy = hand.copy()
    #use letters in hand to formulate word
    for letter in word:
        hand_copy[letter] -= 1
    return hand_copy
...
def isValidWord(word, hand, wordList):
    ...
    if(word in wordList):
        boolean = True
        for letter in word:
            if(letter in hand_copy.keys() and not(hand_copy[letter] == 0)):
                hand_copy[letter] -= 1
            else:
                boolean = False
                break
    ...
    while(handLength > 0):
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print(userWord, "earned", getWordScore(userWord, n), "points. Total ", totalScore, "points")
                print()
                # Update the hand 
                newHand = updateHand(hand, userWord)
